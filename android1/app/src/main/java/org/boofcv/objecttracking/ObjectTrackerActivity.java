        ...
        implements AdapterView.OnItemSelectedListener, View.OnTouchListener
{
    ...
    private static String FILENAME = "ObjectTracking.3gp";
    private File output;
...
//        setShowFPS(true);
    ...
    private void startObjectTracking(int pos) {
        ...
        trackingProcessing = new TrackingProcessing(tracker,imageType);
        setProcessing( trackingProcessing );
    }
...
//        }
        if( bluetoothThread != null ){
            bluetoothThread.run(10000,10000);
